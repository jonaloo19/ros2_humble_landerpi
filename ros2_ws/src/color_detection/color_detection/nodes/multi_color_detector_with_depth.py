...
class MultiColorDetectorWithDepth(Node):
    def __init__(self):
        super().__init__('multi_color_detector_with_depth')
    ...
    def depth_image_callback(self, msg):
        ...
        try:
            ...
            # Display depth info (optional)
            if self.latest_depth_image is not None:
                # Calculate statistics for valid depth values
...
def main(args=None):
    ...
    node = MultiColorDetectorWithDepth()
